      ...
      <section className="bg-gradient-to-r from-[#073A48] to-[#38C5F4] flex flex-col md:flex-row items-center justify-center mx-10 md:mx-20  px-8 md:pl-10 md:pr-0 rounded-3xl min-h-[400px] md:min-h-[450px] shadow-lg py-10 md:py-0">
        <div className="flex flex-col text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start mt-5 gap-4">
            <a href="/Signup">
              <button className="px-6 cursor-pointer h-12 bg-blue-600 text-white rounded-lg hover:scale-105 transition duration-300 shadow-lg">
                Search Trips
              </button>
            </a>
            <a href="/Signup">
              <button className="px-6 cursor-pointer h-12 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-lg hover:bg-white/20 transition">
                Book Now
              </button>
            </a>
          </div>
        ...
        <div className="w-full md:w-[600px] hidden md:flex justify-center md:justify-end mt-8 md:mt-0">
          <Image
            src="/toyota2.png"
            alt="Toyota car"
            width={1000}
